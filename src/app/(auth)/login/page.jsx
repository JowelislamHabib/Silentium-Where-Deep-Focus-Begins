...
const loginBenefits = [
  {
    ...
    text: "See what you booked next and manage changes in one place.",
  },
  {
    icon: RiHistoryLine,
    title: "Full history",
    text: "Completed and cancelled visits stay organized for reference.",
  },
  {
    icon: RiBrainLine,
    title: "Host tools",
    text: "Jump back into listings and bookings without starting over.",
  },
];

const trustPoints = ["Secure sign-in", "Same account for book & host"];
        ...
        <div className="grid w-full items-center gap-10 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 max-w-lg text-base leading-relaxed text-stone-600">
              Sign in to manage bookings, host listings, and get back to quiet
